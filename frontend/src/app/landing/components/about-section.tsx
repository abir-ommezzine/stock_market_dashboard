...
const values = [
  ...
  },
  {
    ...
    description: 'We maintain the highest design standards with modern UI patterns and intuitive interfaces for stock market analysis.'
  },
  {
    icon: Layout,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-6">
            Built for investors, by data scientists
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            We're passionate about creating the best AI-powered stock prediction platform.
            Our mission is to democratize stock market analysis and help investors make informed decisions faster.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="cursor-pointer" asChild>
              <a href="https://github.com/stockai" target="_blank" rel="noopener noreferrer">
