...
const STOCKY_FEATURES_URL = "https://stocky.com/features"
      ...
      <HoverCard openDelay={100} closeDelay={100}>
        <HoverCardTrigger asChild>
          <Button
            ...
            style={{ minWidth: 180 }} onClick={() => window.open(STOCKY_FEATURES_URL, "_blank")}
          >
            Upgrade to Pro
        ...
        <HoverCardContent className="mb-3 w-90 rounded-xl shadow-2xl bg-background border border-border p-3 animate-in fade-in slide-in-from-bottom-4 relative mr-4 md:mr-6 lg:mr-8">
          <div className="flex flex-col items-center text-center gap-3">
            <a href={STOCKY_FEATURES_URL} target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                            <img 
            ...
            <div className="flex flex-row gap-2 w-full mt-2 justify-center">
              <div className="relative w-1/2">
                <a href={STOCKY_FEATURES_URL} target="_blank" rel="noopener noreferrer">
